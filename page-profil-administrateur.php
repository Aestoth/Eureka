                ...
                <div class="container-fluid nav-header-container">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-xs-5">
                            <a href="#" title="Eureka" class="logo"><img src="images/eureka-dark.png" data-rjs="images/logo@2x.png" class="logo-dark default" alt="Eureka"><img src="images/logo-white.png" data-rjs="images/logo-white@2x.png" alt="Eureka" class="logo-light"></a>
                        </div>
                        <!-- end logo -->
                ...
                <div class="container">
                    <div class="row equalize xs-equalize-auto">
                        <div class="col-md-3 col-sm-6 col-xs-12 widget border-right border-color-medium-dark-gray sm-no-border-right sm-margin-30px-bottom xs-text-center">
                            <!-- start logo -->
                            <a href="#" class="margin-20px-bottom display-inline-block"><img class="footer-logo" src="images/logo-white.png" data-rjs="images/logo-white@2x.png" alt=""></a>
                            <!-- end logo -->
