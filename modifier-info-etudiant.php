...
$listeMotClesEtudiant = $appliBD->getEtudiantListeMotCles($idEtudiant);
?>
                                  ...
                                  <div class="col-md-6">
                                    <div class="select-style">
                                        <select name="motClesEtudiant[]" id="motClesEtudiant" class="transparent no-margin-bott">
                                            ...
                                            <?php foreach ($listeMotCles as $motCles){ ?>
                                              <option value="<?php echo $motCles->id?>"
                                                <?php if ($motCles->id === $listeMotClesEtudiant[$i]->id) echo 'selected'; ?>
                                                ><?php echo $motCles->nom ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                  </div>
                                        ...
                                        <table class="table table-bordered">
                                          ...
                                          <tbody>
                                            <tr class="text-center">
                                              ...
                                              $fill = array_fill(0, 14, false);
                                              foreach ($halfDays as $value) {
                                                $fill[$value] = true;
                                              }
                                               ?>

                                              <td><input type="checkbox" name="jourDisponibles[]" value="0" <?php if ($fill[0]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="2" <?php if ($fill[2]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="4" <?php if ($fill[4]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="6" <?php if ($fill[6]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="8" <?php if ($fill[8]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="10" <?php if ($fill[10]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="12" <?php if ($fill[12]) echo "checked"; ?>></td>
                                            </tr>
                                          </tbody>
                                          ...
                                          <tbody>
                                            <tr class="text-center">
                                              <td>pm</td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="1" <?php if ($fill[1]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="3" <?php if ($fill[3]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="5" <?php if ($fill[5]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="7" <?php if ($fill[7]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="9" <?php if ($fill[9]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="11" <?php if ($fill[11]) echo "checked"; ?>></td>
                                              <td><input type="checkbox" name="jourDisponibles[]" value="13" <?php if ($fill[13]) echo "checked"; ?>></td>
