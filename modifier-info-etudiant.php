    ...
    <body>
        ...
        <section class="wow fadeIn">
              ...
              <table class="table table-hover text-left">
                  <tbody>
                      <tr>
                          ...
                          <td>fffffffff<button type="button" class="btn btn-link"><i class="far fa-edit"></i>
                                  modifier</button></td>
                      </tr>
                      <tr>
                          <th scope="row"><i class="far fa-user-circle"></i> PRENOM</th>
                          <td>ffffffffff <button type="button" class="btn btn-link"><i class="far fa-edit"></i>
                                  modifier</button></td>
                      </tr>
                  </tbody>
              </table>
              ...
              <table class="table table-hover text-left">
                  <tbody>
                      <tr>
                          ...
                          <td>fffffffffff<button type="button" class="btn btn-link"><i
          ...
          <div class="cocol-md-4 col-lg-4">
              <table class="table table-hover text-left">
                  <tbody>
                      <tr>
                          <th scope="row"><i class="fas fa-theater-masks"></i>Téléphone</th>
                          <td>fffffffffff<button type="button" class="btn btn-link"><i class="far fa-edit"></i>
                                  modifier</button></td>
                      </tr>
                      <tr>
                          <th scope="row"><i class="far fa-clock"></i>Avatar</th>
      ...
      <div class="form-group col-md-12 mt-3">
        ...
        <table class="table table-bordered">
          <h6 class="mb-3 text-center" style="padding-top: 50px;">Jours Disponibles</h6>
          <thead>
