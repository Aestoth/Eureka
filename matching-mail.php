...
foreach ($projetsActifs as $projet) {
    ...
    foreach ($listeEtudiantMatching as $etudiant) {
        ...
        */
        ...
        $notification = $appliBD->getNotifications($idEtudiants,$idProjet);
        ...
        if(empty($notification)) {
            ...
            * { font-family: "Helvetica Neue", "Helvetica", Helvetica, Arial, sans-serif; }
            ...
            p.lead { font-size:17px; text-align :center; }
                ...
                <tr>
                    ...
                    <td class="container" bgcolor="#FFFFFF">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <h5>Bonjour, vous avez été sélectionné pour le projet</h5>
                                    <p class="lead">'.$projet->getTitre().'</br></p>
                                    <p class="lead">'.$projet->getPhoto().'</br></p>
                                    <p class="lead">'.$projet->getDescription().'</br></p>
                                    <!-- social & contact -->
            ...
            $headers .= "Reply-To: " . $emailEntreprise . "\r\n";
