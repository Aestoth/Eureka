...
class Connexion {
  ...
  public function insertEtudiant($nom, $prenom, $password, $description, $email, $telephone, $avatar, $jourDisponibles, $derniereConnexion){
      ...
      $requete_prepare = $this->connexion->prepare("
       INSERT INTO Etudiant (nom, prenom, password, description, email, telephone, avatar, jourDisponibles, derniereConnexion)
       values (:nom, :prenom, :password, :description, :email, :telephone, :avatar, :jourDisponibles, :derniereConnexion)");
      $requete_prepare->execute(
        array(
              'nom'=> $nom,
              'prenom'=> $prenom,
