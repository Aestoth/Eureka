...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="wow fadeIn cover-background background-position-top top-space" style="background-image:url('https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Ftse2.mm.bing.net%2Fth%3Fid%3DOIP.VTKNoYlv1-nbra3AgwVyrwHaE7%26pid%3D15.1&f=1');">
        ...
        <section class="wow fadeIn" id="start-your-project">
            <div class="container">
                ...
                <form id="project-contact-form" action="formulaire-cible-etudiant.php" method="post">
                    <div class="row">
                         <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="select-style big-select">
                              <?php
                                ...
                                foreach ($listeMotCles as $amis) {
                               echo '<select name="motCles[]" id="budget" class="bg-transparent no-margin-bottom">
                        ...
                        <div class="col-md-12">
                           ...
                           <div id="Kt-profile_acatar_2" class="Kt-avatar Kt-avatar--circle"
