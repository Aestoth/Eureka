...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <section class="wow fadeIn cover-background background-position-top top-space" style="background-image:url('https://proxy.duckduckgo.com/iu/?u=https%3A%2F%2Fphotosfine.files.wordpress.com%2F2012%2F04%2Fbusiness-relation-15.jpg&f=1');">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="select-style big-select">
                                <select name="motCles" id="budget" class="bg-transparent no-margin-bottom">
